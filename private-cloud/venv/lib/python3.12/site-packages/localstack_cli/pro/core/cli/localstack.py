...
@publish_invocation
def cmd_dns_systemd(set_:bool)->_A:import localstack_cli.pro.core.bootstrap.dns_utils;from localstack_cli.pro.core.bootstrap.dns_utils import configure_systemd as A;console.print('Configuring systemd-resolved...');B=localstack_cli.pro.core.bootstrap.dns_utils.LOG.name;localstack_cli.pro.core.bootstrap.dns_utils.LOG=ConsoleLogger(B);A(not set_)
