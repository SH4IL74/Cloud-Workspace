...
from localstack_cli.pro.core.bootstrap.licensingv2 import ApiKeyCredentials,get_credentials_from_environment
from localstack_cli.pro.core.bootstrap.licensingv2 import AuthToken as LSAuthToken
