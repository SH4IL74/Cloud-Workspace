...
def init_extension_venv()->VirtualEnvironment:
	...
	return A
def list_extension_metadata()->list[dict]:from localstack_cli.extensions.api import Extension as A;return list_plugin_distribution_data(PluginManager(A.namespace))
